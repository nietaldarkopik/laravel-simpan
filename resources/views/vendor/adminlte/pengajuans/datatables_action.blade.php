<form action="{{ route('admin.pengajuan.destroy', $id) }}" method="post">
    ...
    <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
        ...
        <a href="{{ route('admin.pengajuan.formUploadPeta', $id) }}" role="button" class="btn btn-warning btn-sm" data-tooltip="tooltip" data-toggle="modal" data-target="#modalLgId" data-modal-size="modal-xl" data-backdrop="static" data-keyboard="false" data-modal-title="Peta" data-title="Upload Peta" title="Upload Peta">
