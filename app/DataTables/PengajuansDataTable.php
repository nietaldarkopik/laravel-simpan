...
class PengajuansDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query, Request $request): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            /* ->addColumn('getKategori', function (PengajuanModel $perumahan) {
                return $perumahan->getKategori->title;
            }) */
            /* ->editColumn('kategori', function (PengajuanModel $perumahan) {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('created_at')->title('Tgl Input')->searchable(true)->visible(true),
            Column::make('updated_at')->title('Tgl Update')->searchable(true)->visible(true),
        ];
    }
